...
<div class="container">
	<div class="content-wrap">
		...
		<div class="write-form-container">
			<form name="my" method="post" action="/pst/post.do"
				...
				<div class="form-group">
					<label for="title">タイトル</label> <input type="text" id="title"
						name="title" class="form-control" placeholder="タイトルを入力してください。">
				</div>

				<div class="form-group">
					<label for="content">内容</label>
					<textarea id="content" name="content" class="form-control"
						placeholder="あなたのストーリーを聞かせてください。"></textarea>
				</div>

				<div class="form-group">
					<label for="file">イメージを追加</label> <input type="file" id="imgfile"
						name="imgfile" class="form-control">
				</div>

				<div class="btn-wrap">
					<a href="/pst/list.do" class="btn btn-cancel">キャンセル</a>
...
<script>
	function check() {
		...
		// 파일 확장자 체크
		if (my.imgfile.value) {
			const fileName = my.file.value.toLowerCase();
